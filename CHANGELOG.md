...
- Made ordinary successful `PostToolUse` events silent no-ops when no credential binding is pending, and forced process-argument plus AWS credential-producing reads through native `ask`.
