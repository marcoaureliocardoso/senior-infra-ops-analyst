...
- Closed RV-96 and RV-97 by proving the CodeQL matrix binds `with.languages` on the unique init step and documenting platform-qualified test totals instead of one ambiguous universal count.
