...
- Required Git push destinations to be explicit URLs, SCP-like addresses, or local paths so named remotes and `pushInsteadOf` rewrites cannot hide the effective repository or helper from binding and audit.
