...
- Closed RV-96 and RV-97 by proving one exact CodeQL matrix drives direct unconditional fail-closed init/analyze steps in the same job, rejecting textual/YAML lookalikes, and documenting platform-qualified test totals instead of one ambiguous universal count.
