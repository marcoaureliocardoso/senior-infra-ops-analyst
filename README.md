...
installation time and is not a source artifact. `--replace` replaces only a
previously recognized staging tree and refuses unexpected content. The builder
does not log in, upload, publish, or change the active Nori profile.
