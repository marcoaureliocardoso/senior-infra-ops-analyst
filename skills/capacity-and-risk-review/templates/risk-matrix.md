...
|---|---|---|---|---|---|---|---|---|---|---|
| Example: no recent restore test for critical VM backups | backup-restore | backup jobs are green, but no restore evidence in last 90 days | high | medium | 7-30 days | partial | service/site | P1 | run isolated restore test and document RTO/RPO result | restored VM/files verified by owner |
...
- P1: high impact and plausible within 7-30 days. Schedule owner and date.
