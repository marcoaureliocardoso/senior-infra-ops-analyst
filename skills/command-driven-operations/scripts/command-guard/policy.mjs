...
export const REASON_CODES = Object.freeze([
  ...
  'DENY_AUTHENTICATED_REDIRECT', 'DENY_UNBOUND_HTTP_REDIRECT', 'DENY_CURL_DEFAULT_CONFIG',
...
export const SECURITY_PREDICATE_IDS = Object.freeze([
  ...
  'CATALOGUE_HTTP_REDIRECT_REJECT', 'CATALOGUE_CURL_DEFAULT_CONFIG_REJECT',
  'CATALOGUE_POWERSHELL_REDIRECT_ZERO',
  'CATALOGUE_POWERSHELL_HEADER_BINDING', 'REDACTION_SECRET_HEADER',
  'REDACTION_PLATFORM_KEY_HEADER',
...
const DENY_GUIDANCE = Object.freeze({
  ...
  DENY_CURL_DEFAULT_CONFIG: 'Place exactly one -q or --disable as the first curl argument so no implicit configuration can alter the audited request.',
