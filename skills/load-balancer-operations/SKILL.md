...
4. Consult `references/load-balancers-reverse-proxies.md` for domain command order, safety rules, and interpretation.
...
9. Use the template `skills/load-balancer-operations/templates/load-balancer-check.md` when producing the final artifact.
</required>
