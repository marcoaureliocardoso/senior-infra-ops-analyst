...
4. Consult `references/pki-certificate-lifecycle.md` for domain command order, safety rules, and interpretation.
...
9. Use the template `skills/pki-certificate-operations/templates/certificate-renewal-plan.md` when producing the final artifact.
</required>
