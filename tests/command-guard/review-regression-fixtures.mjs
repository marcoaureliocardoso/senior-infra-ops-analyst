export const REVIEW_REGRESSION_FIXTURES = Object.freeze([
  ...
  {
    id: 'RV88-GIT-PUSH-POSITIONAL-REWRITE-CONFIRMATION',
    command: 'git push https://git.example.invalid/rewrite-positional.git HEAD:main',
    expectedDecision: 'ask',
    expectedRisk: 'LOW_RISK_CHANGE',
    expectedTarget: 'HEAD:main',
    expectedEnvironment: 'https://git.example.invalid/rewrite-positional.git',
    expectedModifiers: ['ALWAYS_ASK'],
  },
  {
    id: 'RV88-GIT-PUSH-REPO-EQUALS-REWRITE-CONFIRMATION',
    command: 'git push --repo=https://git.example.invalid/rewrite-equals.git HEAD:main',
    expectedDecision: 'ask',
    expectedRisk: 'LOW_RISK_CHANGE',
    expectedTarget: 'HEAD:main',
    expectedEnvironment: 'https://git.example.invalid/rewrite-equals.git',
    expectedModifiers: ['ALWAYS_ASK'],
  },
  {
    id: 'RV88-GIT-PUSH-REPO-SEPARATE-REWRITE-CONFIRMATION',
    command: 'git push --repo https://git.example.invalid/rewrite-separated.git HEAD:main',
    expectedDecision: 'ask',
    expectedRisk: 'LOW_RISK_CHANGE',
    expectedTarget: 'HEAD:main',
    expectedEnvironment: 'https://git.example.invalid/rewrite-separated.git',
    expectedModifiers: ['ALWAYS_ASK'],
  },
  {
  ...
  {
    id: 'RV89-POWERSHELL-MISSING-REDIRECT-CONTROL',
    command: 'Invoke-WebRequest -Uri https://origin.example.invalid/start',
    expectedDecision: 'deny',
    expectedReasonCode: 'DENY_UNBOUND_HTTP_REDIRECT',
  },
  {
    id: 'RV89-POWERSHELL-REDIRECT-ZERO',
    command: 'Invoke-RestMethod -Uri https://api.example.invalid/health -MaximumRedirection 0',
    expectedDecision: 'allow',
    expectedRisk: 'SAFE_READ_ONLY',
    expectedTarget: '/health',
  ...
  },
  {
    ...
    redactionForbiddenText: 'SYNTH_SECRET_rv89',
  },
  {
  ...
  {
    id: 'RV90-GIT-ADD-LITERAL-PATH',
    command: 'git add -- src/app.mjs',
    expectedDecision: 'allow',
    expectedRisk: 'LOW_RISK_CHANGE',
    expectedTarget: 'paths:src/app.mjs',
    expectedEnvironment: 'local',
  },
  {
    id: 'RV90-GIT-ADD-RENORMALIZE',
    command: 'git add --renormalize .',
    expectedDecision: 'allow',
    expectedRisk: 'LOW_RISK_CHANGE',
    expectedTarget: 'scope:renormalize;paths:.',
  },
  {
    id: 'RV90-GIT-COMMIT-AMEND',
    command: 'git commit --amend -m change',
    expectedDecision: 'ask',
    expectedRisk: 'DESTRUCTIVE',
    expectedTarget: 'commit:HEAD',
  },
  {
    id: 'RV90-GIT-TAG-SIGNED',
    command: 'git tag -s v1.2.3 -m release',
    expectedDecision: 'allow',
    expectedRisk: 'LOW_RISK_CHANGE',
    expectedTarget: 'tag:v1.2.3',
  },
  {
    id: 'RV90-GIT-TAG-FORCE',
    command: 'git tag -f v1.2.3',
    expectedDecision: 'ask',
    expectedRisk: 'DESTRUCTIVE',
    expectedTarget: 'tag:v1.2.3',
  },
  {
    id: 'RV90-GIT-TAG-DELETE',
    command: 'git tag --delete v1.2.3',
    expectedDecision: 'ask',
    expectedRisk: 'DESTRUCTIVE',
    expectedTarget: 'tag:v1.2.3',
  },
  {
    id: 'RV90-GIT-ADD-INTERACTIVE-DENY',
    command: 'git add -p src/app.mjs',
    expectedDecision: 'deny',
    expectedReasonCode: 'DENY_UNSUPPORTED_GIT_FORM',
  },
  {
    id: 'RV90-GIT-COMMIT-FILE-DENY',
    command: 'git commit -F message.txt',
    expectedDecision: 'deny',
    expectedReasonCode: 'DENY_UNSUPPORTED_GIT_FORM',
  },
  {
    id: 'RV90-GIT-TAG-LIST-DENY',
